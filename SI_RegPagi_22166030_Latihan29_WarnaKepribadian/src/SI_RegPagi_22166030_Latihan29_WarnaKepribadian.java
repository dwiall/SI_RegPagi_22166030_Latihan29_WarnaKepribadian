 ...
 * NIM      : 22166030
 * Deskripsi program : Pembuatan program melihat kepribadian seseorang dari warna
 */
public class SI_RegPagi_22166030_Latihan29_WarnaKepribadian {
    public static void main(String[] args) {
        ...
        //Mencetak hasil test kepribadian nama yang telah diinputkan
        System.out.println("\n====HASIL TEST KEPRIBADIAN " + nama +"====");
        System.out.print("Warna favoritmu adalah ");
        
        //Memilih blok kode yang akan dieksekusi berdasarkan variabel "warna".
        switch (warna) {
            case "merah":
